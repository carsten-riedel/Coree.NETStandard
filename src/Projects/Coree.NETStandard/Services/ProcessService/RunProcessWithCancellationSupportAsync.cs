...
namespace Coree.NETStandard.Services
{
    ...
    public partial class ProcessService : IProcessService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessService"/> class, setting up logging capabilities to monitor and log process execution details. This constructor ensures the necessary dependencies are in place for the service to operate.
        /// </summary>
        /// <param name="logger">The logger used to log information, warnings, and errors related to process management and execution.</param>
        /// <exception cref="ArgumentNullException">Thrown if the provided <paramref name="logger"/> is null.</exception>
